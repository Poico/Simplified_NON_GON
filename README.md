# Simplified_NON_GON is a Collision Detection Toolbox for Unity and the Web that efficiently processes smooth convex object interactions using proximity queries and minimum closest distance algorithms.
